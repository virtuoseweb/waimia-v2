  ...
  cols: [
    ...
    },
    {
      ...
      items: [
        ...
        { href: '/commerce', label: { en: 'Commerce catalogue', fr: 'Catalogue commerce' }, lead: { en: 'Productized AI offers · templates · ready to deploy.', fr: 'Offres IA packagées · templates · prêts à déployer.' } },
      ],
    },
  ],
  featured: {
  ...
  cols: [
    {
      ...
      items: [
        ...
        { href: '/ressources/testimonials', label: { en: 'Client testimonials', fr: 'Témoignages clients' } },
        { href: '/ressources/personas', label: { en: 'Buyer personas · 3 profiles', fr: 'Personas clients · 3 profils' }, lead: { en: 'Buyer profiles to tailor your AI messaging.', fr: 'Profils acheteurs pour cibler votre communication IA.' } },
        { href: '/ressources/cas/virtuoseos', label: { en: 'VirtuoseOS · blueprint case', fr: 'VirtuoseOS · cas blueprint' }, featured: true },
        { href: '/ecole', label: { en: 'AI School · 3 courses', fr: 'École IA · 3 formations' }, lead: { en: 'Practical AI training for SMB teams.', fr: 'Formations IA pratiques pour équipes PME.' } },
    ...
    },
    {
      ...
      items: [
        ...
        { href: ‘/glossaire’, label: { en: ‘AI Glossary · 15 terms’, fr: ‘Glossaire IA · 15 termes’ }, lead: { en: ‘Key AI concepts for non-technical SMB managers.’, fr: ‘Concepts IA clés pour dirigeants PME non-techniques.’ } },
  ...
  cols: [
    {
      ...
      items: [
        ...
        { href: '/agence/design-system', label: { en: 'Design System · brand & tokens', fr: 'Design System · brand & tokens' }, lead: { en: 'Our full brand catalogue — exposed.', fr: 'Notre catalogue brand complet — exposable.' } },
