  ...
  cols: [
    {
      ...
      items: [
        ...
        { href: '/ecole', label: { en: 'School · AI training catalog', fr: "Ecole · catalogue formations IA" }, lead: { en: 'Technical Claude + agents sessions.', fr: 'Sessions techniques Claude + agents.' } },
        { href: '/ecole/formation/intro-ia-pme-b2b', label: { en: 'AI for B2B SMBs · 2h', fr: "IA pour PME B2B · 2h" }, featured: true },
        { href: '/ecole/formation/prompter-claude-pour-les-non-tech', label: { en: 'Prompting Claude · non-tech · 90min', fr: 'Prompter Claude · non-tech · 90min' } },
        { href: '/ecole/formation/automatiser-relances-crm-en-4-heures', label: { en: 'CRM follow-ups · 4h workshop', fr: 'Relances CRM · 4h workshop' } },
