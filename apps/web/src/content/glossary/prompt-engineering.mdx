...
seo:
  meta_description_fr: "Prompt engineering : définition, techniques (Chain-of-Thought, few-shot, system prompt) et applications concrètes pour optimiser vos workflows IA en entreprise."
